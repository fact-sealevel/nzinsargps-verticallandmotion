...
def NZInsarGPS_postprocess_verticallandmotion(
    preprocess_dict,
    nsamps,
    rng_seed,
    locationfilename,
    ...
    nc_missing_value = (
        -9999
    )  # EM added to be able to write xr.ds w/ int dtype. np.nan #np.iinfo(np.int16).min
    ...
    ncvar_attributes = {
        "description": "Local SLR contributions from vertical land motion according to NZInsarGPS workflow",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the post-processing stage for the NZInsarGPS vertical land motion workflow",
