...
def NZInsarGPS_preprocess_verticallandmotion(
    inputfile: str,
    ...
    # Read input file
    (lats, lons, vlm_rates, bop_rates, sigmas, qfs) = ReadNZVLM(
        inputfile, min_quality_flag
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the pre-processing stage for the NZInsarGPS vertical land motion workflow",
    ...
    NZInsarGPS_preprocess_verticallandmotion(
        args.pipeline_id, args.min_qf, args.use_boprates
    )
